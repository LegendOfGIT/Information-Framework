                    ...
                    foreach (ModificationColor modification in colormodifications)  {
                        ...
                        if (target.HasValue){
                            if (objectcolor.R > target.Value) {
                                objectcolor.R -= modification.ChangingVector; objectcolor.R = objectcolor.R < 0 ? 0 : objectcolor.R;
                            }
                            else if (objectcolor.R < target.Value) {
                                objectcolor.R += modification.ChangingVector; objectcolor.R = objectcolor.R > 255 ? 255 : objectcolor.R;
                            }
                        }
                        ...
                        if (target.HasValue){
                            if (objectcolor.G > target.Value) {
                                objectcolor.G -= modification.ChangingVector; objectcolor.G = objectcolor.G < 0 ? 0 : objectcolor.G;
                            }
                            else if (objectcolor.G < target.Value) {
                                objectcolor.G += modification.ChangingVector; objectcolor.G = objectcolor.G > 255 ? 255 : objectcolor.G;
                            }
                        }
                        ...
                        if (target.HasValue){
                            if (objectcolor.B > target.Value) {
                                objectcolor.B -= modification.ChangingVector; objectcolor.B = objectcolor.B < 0 ? 0 : objectcolor.B;
                            }
                            else if (objectcolor.B < target.Value) {
                                objectcolor.B += modification.ChangingVector; objectcolor.B = objectcolor.B > 255 ? 255 : objectcolor.B;
                            }
                        }
